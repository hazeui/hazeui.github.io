import"./DsnmJJEf.js";import{af as Le,k as Ee,ag as Be,o as Te,aV as ze,p as A,aK as R,b as I,a as s,c as q,f as d,e as b,s as l,r as m,h as j,g as p,ai as M,aL as de,ak as P,aj as ie,ab as ye,a9 as X,j as we,aJ as oe,n as _,t as O}from"./DtczRlXZ.js";import{a as N,f as ke,d as K,s as $e}from"./R0Tc61iS.js";import{p as se,i as F,r as le,s as je}from"./Bsd_8zgC.js";import{b as Oe,c as Ae}from"./DyKfUtFv.js";import{o as qe}from"./C1fZ_kB7.js";import{d as Fe,s as U,r as Ne,a as ue,c as G,b as V}from"./CrKGSx_S.js";import"./69_IOA4Y.js";import{B as L}from"./BXt25yBm.js";import{e as Re}from"./CEuL__aB.js";function pe(o,e,n){Le(()=>{var t=Ee(()=>e(o,n?.())||{});if(n&&t?.update){var a=!1,r={};Be(()=>{var i=n();Te(i),a&&ze(r,i)&&(r=i,t.update(i))}),a=!0}if(t?.destroy)return()=>t.destroy()})}const be=o=>o?typeof o=="string"?document.querySelector(o):o:null;function Me(o,e="body"){return be(e)?.appendChild(o),{update:n=>{n!==e&&(o.parentNode?.removeChild(o),be(n)?.appendChild(o))},destroy:()=>{o.parentNode?.removeChild(o)}}}const Ue=o=>{o.currentTarget==o.target&&close()};var Ve=d('<button class="i-pajamas:close absolute right-4 top-4 focus:bg-red" aria-label="close" tabindex="-1"></button>'),We=d('<dialog class="backdrop:bg-black/60"><div tabindex="-1"><!> <!></div></dialog>');function Ge(o,e){A(e,!0);let n=se(e,"closeIcon",3,!0);var t=R(),a=I(t);{var r=i=>{var c=We();c.__click=[Ue];var f=b(c),g=b(f);{var h=y=>{var w=Ve();w.__click=function(...S){e.close?.apply(this,S)},s(y,w)};F(g,y=>{n()&&y(h)})}var v=l(g,2);N(v,()=>e.children),m(f),m(c),pe(c,y=>Me?.(y)),Fe(c,()=>y=>y.showModal()),j(()=>U(f,1,`dialog ${e.class}`)),ke("close",c,function(...y){e.close?.apply(this,y)}),s(i,c)};F(a,i=>{e.open&&i(r)})}s(o,t),q()}K(["click"]);var He=d("<div></div>"),Ke=d("<div></div>"),Je=d("<div><!> <input/> <!></div>");function W(o,e){A(e,!0);let n=se(e,"class",3,""),t=le(e,["$$slots","$$events","$$legacy","iconL","iconR","class"]);var a=Je(),r=b(a);{var i=h=>{var v=R(),y=I(v);{var w=u=>{var x=He();j(()=>U(x,1,G(e.iconL))),s(u,x)},S=u=>{var x=R(),$=I(x);N($,()=>e.iconL),s(u,x)};F(y,u=>{typeof e.iconL=="string"?u(w):u(S,!1)})}s(h,v)};F(r,h=>{e.iconL&&h(i)})}var c=l(r,2);Ne(c),ue(c,()=>({...t}));var f=l(c,2);{var g=h=>{var v=R(),y=I(v);{var w=u=>{var x=Ke();j(()=>U(x,1,G(e.iconR))),s(u,x)},S=u=>{var x=R(),$=I(x);N($,()=>e.iconR),s(u,x)};F(y,u=>{typeof e.iconR=="string"?u(w):u(S,!1)})}s(h,v)};F(f,h=>{e.iconR&&h(g)})}m(a),j(h=>U(a,1,h),[()=>G(n()?.includes("grinput")?n():`grinput ${n()}`)]),s(o,a),q()}const De=(o,e)=>{function n(t){o.contains(t.target)||e()}return document.addEventListener("click",n),{destroy(){document.removeEventListener("click",n)}}};var Qe=()=>null,Xe=d("<span></span>"),Ye=d('<li role="option"><!> </li>'),Ze=d('<ul role="listbox"></ul>'),en=d('<div class="relative inline-flex first:children:w-full"><!> <!></div>');function ae(o,e){A(e,!0);let n=se(e,"placeholder",3,"Select Option"),t=M(!1),a=M(-1),r=M(-1);const i=()=>{P(t,!p(t)),p(t)&&P(r,p(a),!0)},c=u=>{u!==p(a)&&(P(a,u,!0),e.onChange?.(e.options[u].value)),P(t,!1)},f=u=>{switch(u.preventDefault(),u.key){case"Enter":c(p(r));break;case"Escape":P(t,!1);break;case"ArrowUp":P(r,p(r)>0?p(r)-1:0,!0);break;case"ArrowDown":P(r,p(r)<e.options.length-1?p(r)+1:0,!0);break}},h=`justify-start btn-ghost-eqmd transition-none ${e.optionCss?.includes("data-")?e.optionCss:`data-active:bg-mutedbg ${e.optionCss}`}`;var v=en(),y=b(v);{let u=de(()=>e.options[p(a)]?.name||n());L(y,je({"aria-haspopup":"listbox",get"aria-expanded"(){return p(t)},onclick:i,onkeydown:f,iconR:"ml-auto i-fa-solid:caret-down",get txt(){return p(u)}},()=>e.triggerProps))}var w=l(y,2);{var S=u=>{var x=Ze();V(x,"tabindex",-1),Re(x,23,()=>e.options,$=>$.value,($,B,T)=>{var C=Ye();V(C,"tabindex",-1),C.__click=()=>c(p(T)),C.__keydown=[Qe];var H=b(C);{var Y=E=>{var k=Xe();j(()=>U(k,1,G(p(B).iconL))),s(E,k)};F(H,E=>{p(B).iconL&&E(Y)})}var D=l(H);m(C),j(()=>{V(C,"id",`option-${p(T)}`),V(C,"aria-selected",p(a)===p(T)),V(C,"data-active",p(r)===p(T)),U(C,1,G(h)),$e(D,` ${p(B).name??""}`)}),s($,C)}),m(x),j(()=>{U(x,1,`popover z-10 whitespace-nowrap ${e.dropdownCss}`),V(x,"aria-activedescendant",`option-${p(r)}`)}),s(u,x)};F(w,u=>{p(t)&&u(S)})}m(v),pe(v,(u,x)=>De?.(u,x),()=>()=>P(t,!1)),s(o,v),q()}K(["click","keydown"]);function ve(o,e){A(e,!0);let n=M(ie(e.defaultValue)),t=ie([]);const a=c=>P(n,c,!0);ye("tabs",{value:()=>e.value??p(n),setValue:e.setValue??a,tabLabels:()=>t,addTabLabel:c=>t.push(c)});var r=R(),i=I(r);N(i,()=>e.children),s(o,r),q()}const nn=(o,e,n)=>e(n.value);var tn=d('<button role="tab"><!></button>');function Q(o,e){A(e,!0);const{value:n,setValue:t,addTabLabel:a}=X("tabs");qe(()=>a(e.value));var r=tn();r.__click=[nn,t,e];var i=b(r);N(i,()=>e.children),m(r),j(c=>V(r,"aria-selected",c),[()=>n()==e.value]),s(o,r),q()}K(["click"]);var an=d('<div role="tabpanel"><!></div>');function fe(o,e){A(e,!0);const{value:n}=X("tabs");var t=R(),a=I(t);{var r=i=>{var c=an(),f=b(c);N(f,()=>e.children),m(c),j(g=>V(c,"aria-labelledby",g),[()=>`tab-${n()}`]),s(i,c)};F(a,i=>{n()==e.value&&i(r)})}s(o,t),q()}const on=(o,e,n,t)=>{o.key=="ArrowLeft"&&p(e)!=0?n(t()[p(e)-1]):o.key=="ArrowRight"&&p(e)!=t().length-1&&n(t()[p(e)+1])};var sn=d('<div role="tablist" tabindex="-1"><!></div>');function he(o,e){A(e,!0);const{value:n,tabLabels:t,setValue:a}=X("tabs");let r=de(()=>t().indexOf(n()));we(()=>{n()||a(t()[0])});var i=sn();i.__keydown=[on,r,a,t];var c=b(i);N(c,()=>e.children),m(i),j(f=>U(i,1,f),[()=>G(e.class?.includes("tabs-")?e.class:`tabs ${e.class}`)]),s(o,i),q()}K(["keydown"]);var ln=d('<div class="relative inline-block"><!></div>');function ge(o,e){A(e,!0);let n=M(!1);const t=()=>P(n,!p(n)),a=()=>P(n,!1);ye("dropdown",{open:()=>p(n),toggleDropdown:t,closeDropdown:a});var i=ln(),c=b(i);N(c,()=>e.children??oe),m(i),pe(i,(f,g)=>De?.(f,g),()=>a),s(o,i),q()}const rn=(o,e,n,t)=>{if(!e())return;const a=n();a.length!==0&&(o.key=="ArrowDown"&&p(t)<a.length?(o.preventDefault(),P(t,p(t)+1),a[p(t)]?.focus()):o.key=="ArrowUp"&&p(t)>0&&(P(t,p(t)-1),a[p(t)]?.focus()))};var cn=d('<div role="menu" tabindex="0"><!></div>');function xe(o,e){A(e,!0);let n=se(e,"class",3,""),t=M(-1),a=M(null);const{open:r}=X("dropdown"),i=()=>p(a)?Array.from(p(a).querySelectorAll('[role="menuitem"]')):[];we(()=>{r()&&p(a)?.focus()});var c=R(),f=I(c);{var g=h=>{var v=cn();v.__keydown=[rn,r,i,t];var y=b(v);N(y,()=>e.children??oe),m(v),Oe(v,w=>P(a,w),()=>p(a)),j(w=>U(v,1,w),[()=>G(n().includes("popover")?n():`popover ${n()}`)]),s(h,v)};F(f,h=>{r()&&h(g)})}s(o,c),q()}K(["keydown"]);var dn=d("<button><!></button>");function _e(o,e){A(e,!0);const{toggleDropdown:n}=X("dropdown");let t=le(e,["$$slots","$$events","$$legacy","children","class"]);var a=dn();ue(a,i=>({class:i,onclick:n,...t}),[()=>e.class?.includes("btn")?e.class:`btn ${e.class}`]);var r=b(a);N(r,()=>e.children??oe),m(a),s(o,a),q()}var un=d("<button><!></button>");function z(o,e){A(e,!0);let n=le(e,["$$slots","$$events","$$legacy","children","class"]);const{closeDropdown:t}=X("dropdown");var a=un();ue(a,()=>({onclick:t,class:`btn-ghost-eqmd focus:bg-input justify-start whitespace-nowrap ${e.class}`,role:"menuitem",...n}));var r=b(a);N(r,()=>e.children??oe),m(a),s(o,a),q()}var pn=d('<i class="i-mage:preview-fill"></i> Preview',1),mn=d('<i class="i-majesticons:code"></i> Code',1),bn=d("<!> <!>",1),vn=d('<i class="i-devicon:html5"></i> file.html',1),fn=d('<i class="i-devicon:svelte"></i> Svelte',1),hn=d('<i class="i-devicon:react"></i> React',1),gn=d('<i class="i-devicon:solidjs"></i> Solid',1),xn=d("<!> <!> <!>",1),_n=d('<!> <pre class="p5 rounded brd rounded-t-0 max-h-400px overflow-auto"><code> </code></pre>',1),yn=d("<!> <!> <!>",1);function ca(o,e){const n=le(e,["$$slots","$$events","$$legacy"]);let{demo:t}=n,a=ie({svelte:"",react:"",solid:"",html:""}),r=M(null);const i=c=>{if(P(r,c,!0),c==="svelte"&&!a.svelte&&t.code.svelte)a.svelte=t.code.svelte;else if(c==="react"&&!a.react&&t.code.react){const f=t.code.react;a.react=f.replaceAll("class=","className="),!a.solid&&!t.code.solid&&(a.solid=f.replaceAll("react","solid"))}else c==="solid"&&!a.solid&&t.code.solid?a.solid=t.code.solid:c==="html"&&!a.html&&t.code.html&&(a.html=t.code.html)};ve(o,{defaultValue:"preview",children:(c,f)=>{var g=yn(),h=I(g);he(h,{class:"tabs w-fit p1 !children:p2 !children:px3",children:(w,S)=>{var u=bn(),x=I(u);Q(x,{value:"preview",children:(B,T)=>{var C=pn();_(),s(B,C)},$$slots:{default:!0}});var $=l(x,2);Q($,{value:"code",children:(B,T)=>{var C=mn();_(),s(B,C)},$$slots:{default:!0}}),s(w,u)},$$slots:{default:!0}});var v=l(h,2);fe(v,{value:"preview",children:(w,S)=>{var u=R();const x=de(()=>t.preview);var $=I(u);Ae($,()=>p(x),(B,T)=>{T(B,{})}),s(w,u)},$$slots:{default:!0}});var y=l(v,2);fe(y,{value:"code",children:(w,S)=>{ve(w,{get value(){return p(r)},setValue:i,children:(u,x)=>{var $=_n(),B=I($);he(B,{class:"tabs-line-primary brd rounded-t [&>button]:capitalize",children:(Y,D)=>{var E=R(),k=I(E);{var Ie=J=>{Q(J,{value:"html",children:(ne,re)=>{var te=vn();_(),s(ne,te)},$$slots:{default:!0}})},Se=J=>{var ne=xn(),re=I(ne);Q(re,{value:"svelte",children:(Z,me)=>{var ee=fn();_(),s(Z,ee)},$$slots:{default:!0}});var te=l(re,2);Q(te,{value:"react",children:(Z,me)=>{var ee=hn();_(),s(Z,ee)},$$slots:{default:!0}});var Pe=l(te,2);Q(Pe,{value:"solid",children:(Z,me)=>{var ee=gn();_(),s(Z,ee)},$$slots:{default:!0}}),s(J,ne)};F(k,J=>{t.code.html?J(Ie):J(Se,!1)})}s(Y,E)},$$slots:{default:!0}});var T=l(B,2),C=b(T),H=b(C,!0);m(C),m(T),j(()=>$e(H,p(r)?a[p(r)]:"")),s(u,$)},$$slots:{default:!0}})},$$slots:{default:!0}}),s(c,g)},$$slots:{default:!0}})}var wn=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><!> <!> <!></div>');function kn(o){var e=wn(),n=b(e);L(n,{class:"btn-success",txt:"Success"});var t=l(n,2);L(t,{class:"btn-warning",txt:"Warning"});var a=l(t,2);L(a,{class:"btn-danger",txt:"danger"}),m(e),s(o,e)}var $n=d('<div class="flex flex-gap3 flex-wrap items-center brd p10 rounded"><button class="btn-primary">Primary</button> <button class="btn-soft">Soft</button> <button class="btn-outline">Outline</button> <button class="btn-ghost">Ghost</button> <button class="btn-emerald5 text-white"><i class="i-line-md:email-filled"></i> Email</button> <button class="btn-outline btn"><i class="i-iconamoon:send"></i> Send us</button> <button class="btn-soft"><i class="i-eos-icons:loading"></i> Fetching...</button> <button class="btn-primary-eqmd" aria-label="plus button"><i class="i-tabler:plus"></i></button> <button class="btn-outline-eqmd rounded-full btn" aria-label="user button"><i class="i-iconoir:user"></i></button> <hr class="w-full brd mt3 mb1"/> <button class="btn-soft-xs">Button</button> <button class="btn-soft-sm">Button</button> <button class="btn-soft-md">Button</button> <button class="btn-soft-lg">Button</button> <button class="btn-soft-xl">Button</button></div>');function Dn(o){var e=$n();s(o,e)}var Cn=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><!> <!> <!> <!> <!></div>');function In(o){var e=Cn(),n=b(e);L(n,{class:"btn-emerald5 text-white",iconL:"i-line-md:email-filled",txt:"Email"});var t=l(n,2);L(t,{iconL:"i-iconamoon:send",txt:"Send us",class:"btn-outline"});var a=l(t,2);L(a,{loading:!0,loaderTxt:"Fetching...",disabled:!0,txt:"Fetch data"});var r=l(a,2);L(r,{iconL:"i-tabler:plus",class:"btn-primary-eqmd","aria-label":"plus button"});var i=l(r,2);L(i,{iconL:"i-iconoir:user",class:"btn-outline-eqmd rounded-full","aria-label":"user button"}),m(e),s(o,e)}var Sn=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><!> <!> <!> <!> <!></div>');function Pn(o){var e=Sn(),n=b(e);L(n,{class:"btn-soft-xs",txt:"Success"});var t=l(n,2);L(t,{class:"btn-soft-sm",txt:"Success"});var a=l(t,2);L(a,{class:"btn-soft-md",txt:"Success"});var r=l(a,2);L(r,{class:"btn-soft-lg",txt:"Success"});var i=l(r,2);L(i,{class:"btn-soft-xl",txt:"Success"}),m(e),s(o,e)}var Ln=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><!> <!> <!> <!></div>');function En(o){var e=Ln(),n=b(e);L(n,{txt:"Primary",class:"btn-primary"});var t=l(n,2);L(t,{class:"soft",txt:"Soft"});var a=l(t,2);L(a,{class:"btn-outline",txt:"Outline"});var r=l(a,2);L(r,{class:"btn-ghost",txt:"Ghost"}),m(e),s(o,e)}var Bn=d('<div class="flex flex-gap3 flex-wrap items-center brd p10 rounded"><input type="checkbox" class="checkbox"/> <input type="checkbox" class="checkbox-primary"/> <input type="checkbox" class="checkbox-red"/> <input type="checkbox" class="checkbox-amber4"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-sm"/> <input type="checkbox" class="checkbox-md"/> <input type="checkbox" class="checkbox-lg"/> <input type="checkbox" class="checkbox-xl"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-sm"/> <input type="checkbox" class="checkbox-indigo-md"/> <input type="checkbox" class="checkbox-red-lg"/> <input type="checkbox" class="checkbox-slate-xl"/> <input type="checkbox" class="checkbox-xl !after:checked:i-ph:check-fat-fill !after:checked:size-6"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-blue text-white"/> <input type="checkbox" class="checkbox-amber text-amber8"/> <input type="checkbox" class="checkbox-emerald"/> <input type="checkbox" class="checkbox checked:bg-bg text-fg"/></div>');function Tn(o){var e=Bn(),n=l(b(e),2);n.defaultChecked=!0;var t=l(n,2);t.defaultChecked=!0;var a=l(t,2);a.defaultChecked=!0;var r=l(a,4);r.defaultChecked=!0;var i=l(r,2);i.defaultChecked=!0;var c=l(i,2);c.defaultChecked=!0;var f=l(c,2);f.defaultChecked=!0;var g=l(f,4);g.defaultChecked=!0;var h=l(g,2);h.defaultChecked=!0;var v=l(h,2);v.defaultChecked=!0;var y=l(v,2);y.defaultChecked=!0;var w=l(y,2);w.defaultChecked=!0;var S=l(w,4);S.defaultChecked=!0;var u=l(S,2);u.defaultChecked=!0;var x=l(u,2);x.defaultChecked=!0;var $=l(x,2);$.defaultChecked=!0,m(e),s(o,e)}var zn=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><input type="checkbox" id="option" class="checkbox-fg"/> <label for="option">Option</label></div>');function jn(o){var e=zn(),n=b(e);n.defaultChecked=!0,_(2),m(e),s(o,e)}var On=d('<div class="flex brd p20 rounded-xl justify-center"><div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr]"><input type="checkbox" id="tnc" class="checkbox"/> <label for="tnc">I agree to the Terms and Conditions</label> <input type="checkbox" id="tnc2" class="checkbox-blue"/> <div><label for="tnc2">I understand and read the privacy policy</label> <br/> <span class="text-mutedfg text-sm">By Agreeing you accept our <a class="link" href="/">Privacy Policy</a></span></div> <input type="checkbox" id="tnc3" class="checkbox-slate" disabled/> <label for="tnc3" class="muted-70">I have freedom of speech</label></div></div>');function An(o){var e=On(),n=b(e),t=b(n);t.defaultChecked=!0;var a=l(t,4);a.defaultChecked=!0,_(6),m(n),m(e),s(o,e)}const qn=(o,e)=>P(e,!0);var Fn=d('<h3>Edit Account</h3> <p class="text-mutedfg mb2">Make changes to your user profile here.</p> <label for="name">Name</label> <input class="input-outline" id="name" placeholder="Enter your name"/> <label for="email">Email</label> <input type="email" class="input-outline" id="email" placeholder="Enter your email"/> <div class="flex gap3 items-center ml-auto mt3"><button class="btn-soft">Cancel</button> <button class="btn-primary">Save</button></div>',1),Nn=d('<div class="flex flex-gap3 flex-wrap items-center brd p10 rounded"><button class="btn-primary mx-auto">Open</button> <!></div>');function Rn(o){let e=M(!1);const n=()=>P(e,!1);var t=Nn(),a=b(t);a.__click=[qn,e];var r=l(a,2);Ge(r,{get open(){return p(e)},close:n,class:"grid gap4",children:(i,c)=>{var f=Fn(),g=l(I(f),12),h=b(g);h.__click=n,_(2),m(g),s(i,f)},$$slots:{default:!0}}),m(t),s(o,t)}K(["click"]);var Mn=d('<!> <!> <!> <!> <hr class="brd my1"/> <!> <!> <!> <hr class="brd my1"/> <!> <!> <!> <hr class="brd my1"/> <!>',1),Un=d("<!> <!>",1),Vn=d('<i class="i-line-md:star-filled"></i> With icons',1),Wn=d('<i class="i-line-md:account"></i>Profile',1),Gn=d('<i class="i-nimbus:cog"></i>Settings',1),Hn=d('<i class="i-line-md:logout"></i>Log out',1),Kn=d("<!> <!> <!>",1),Jn=d("<!> <!>",1),Qn=d('<div class="flex flex-gap3 flex-wrap justify-center brd p20 rounded"><!> <!></div>');function Xn(o){var e=Qn(),n=b(e);ge(n,{children:(a,r)=>{var i=Un(),c=I(i);_e(c,{class:"btn-primary",children:(g,h)=>{_();var v=O("Click me");s(g,v)},$$slots:{default:!0}});var f=l(c,2);xe(f,{children:(g,h)=>{var v=Mn(),y=I(v);z(y,{children:(D,E)=>{_();var k=O("Profile");s(D,k)},$$slots:{default:!0}});var w=l(y,2);z(w,{children:(D,E)=>{_();var k=O("Billing");s(D,k)},$$slots:{default:!0}});var S=l(w,2);z(S,{children:(D,E)=>{_();var k=O("Settings");s(D,k)},$$slots:{default:!0}});var u=l(S,2);z(u,{children:(D,E)=>{_();var k=O("Keyboard shortcuts");s(D,k)},$$slots:{default:!0}});var x=l(u,4);z(x,{children:(D,E)=>{_();var k=O("Team");s(D,k)},$$slots:{default:!0}});var $=l(x,2);z($,{children:(D,E)=>{_();var k=O("Invite users");s(D,k)},$$slots:{default:!0}});var B=l($,2);z(B,{children:(D,E)=>{_();var k=O("New Team");s(D,k)},$$slots:{default:!0}});var T=l(B,4);z(T,{children:(D,E)=>{_();var k=O("GitHub");s(D,k)},$$slots:{default:!0}});var C=l(T,2);z(C,{children:(D,E)=>{_();var k=O("Support");s(D,k)},$$slots:{default:!0}});var H=l(C,2);z(H,{disabled:!0,children:(D,E)=>{_();var k=O("API");s(D,k)},$$slots:{default:!0}});var Y=l(H,4);z(Y,{children:(D,E)=>{_();var k=O("Log out");s(D,k)},$$slots:{default:!0}}),s(g,v)},$$slots:{default:!0}}),s(a,i)},$$slots:{default:!0}});var t=l(n,2);ge(t,{children:(a,r)=>{var i=Jn(),c=I(i);_e(c,{class:"btn-soft",children:(g,h)=>{var v=Vn();_(),s(g,v)},$$slots:{default:!0}});var f=l(c,2);xe(f,{children:(g,h)=>{var v=Kn(),y=I(v);z(y,{children:(u,x)=>{var $=Wn();_(),s(u,$)},$$slots:{default:!0}});var w=l(y,2);z(w,{children:(u,x)=>{var $=Gn();_(),s(u,$)},$$slots:{default:!0}});var S=l(w,2);z(S,{children:(u,x)=>{var $=Hn();_(),s(u,$)},$$slots:{default:!0}}),s(g,v)},$$slots:{default:!0}}),s(a,i)},$$slots:{default:!0}}),m(e),s(o,e)}const Yn=(o,e)=>{P(e,p(e)==="text"?"password":"text",!0)};var Zn=d('<button type="button" class="btn-ghost-eqsm rounded-full mr--2" aria-label="Toggle password visibility"><i></i></button>'),et=d('<div class="flex flex-gap5 flex-wrap items-center brd p10 py20 rounded justify-center"><form class="grid gap3"><label for="email" class="reqstar">Email</label> <!> <label for="passwd">Password</label> <!> <input type="submit" class="!btn-primary ml-auto mt3"/></form></div>');function nt(o,e){A(e,!0);let n=M("password");const t=f=>{f.preventDefault();const g=new FormData(f.target),h=g.get("email"),v=g.get("passwd");alert(`
Email: ${h}
Password: ${v}`)};var a=et(),r=b(a),i=l(b(r),2);W(i,{required:!0,name:"email",id:"email",placeholder:"Enter email",type:"email",iconL:"i-line-md:email",class:"grinput-outline mb3"});var c=l(i,4);W(c,{name:"passwd",id:"passwd",placeholder:"Enter Password",get type(){return p(n)},iconL:"i-lucide:key-round",class:"grinput-outline",iconR:g=>{var h=Zn();h.__click=[Yn,n];var v=b(h);m(h),j(()=>U(v,1,G(p(n)=="text"?"i-heroicons-solid:eye":"i-heroicons-solid:eye-off"))),s(g,h)},$$slots:{iconR:!0}}),_(2),m(r),m(a),ke("submit",r,t),s(o,a),q()}K(["click"]);var tt=d('<div class="flex flex-col flex-gap5 flex-wrap items-center brd p10 rounded"><input class="input" placeholder="Enter name"/> <input class="input-outline" placeholder="Enter name"/> <br/> <p>sizes</p> <input class="input-outline-sm" placeholder="Enter name"/> <input class="input-outline-md" disabled placeholder="Enter name"/> <input class="input-lg" placeholder="Enter name"/> <input class="input-outline-xl" placeholder="Enter name"/> <p>Icons</p> <div class="grid grid-cols-2 grid-gap5"><div class="grinput"><i class="i-ri:user-line"></i> <input placeholder="Enter name"/></div> <div class="grinput-outline"><i class="i-line-md:email-filled"></i> <input placeholder="Enter name"/></div> <div class="grinput p0"><span class="bg-border p2 px3 rounded-l">$</span> <input placeholder="Enter price" type="number"/></div> <div class="grinput p0"><span class="bg-border p2 px3 rounded-l">$</span> <input placeholder="Enter salary" disabled/></div> <div class="grinput-outline p0 col-span-2"><span class="bg-mutedbg p2 px3 rounded-l">$</span> <input placeholder="Enter name"/> <span class="bg-mutedbg p2 rounded-r">USD</span></div></div></div>');function at(o){var e=tt();s(o,e)}var ot=d('<div class="grid grid-gap5 grid-wrap items-center brd p5 rounded"><!> <!> <!> <!></div>');function st(o){var e=ot(),n=b(e);W(n,{placeholder:"size (sm)",class:"grinput-sm"});var t=l(n,2);W(t,{placeholder:"size (md)",class:"grinput-md"});var a=l(t,2);W(a,{placeholder:"size (lg)",class:"grinput-lg"});var r=l(a,2);W(r,{placeholder:"size (xl)",class:"grinput-outline-xl"}),m(e),s(o,e)}var lt=d('<div class="flex flex-gap5 flex-wrap items-center brd p10 rounded justify-center"><!> <!></div>');function rt(o){var e=lt(),n=b(e);W(n,{placeholder:"Enter name"});var t=l(n,2);W(t,{placeholder:"Enter name",class:"grinput-outline"}),m(e),s(o,e)}var it=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded"><input type="radio" class="radio" name="group1"/> <input type="radio" class="radio-primary" name="group1"/> <input type="radio" class="radio-red" name="group1"/> <input type="radio" class="radio-amber4" name="group1"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radio-sm" name="group2"/> <input type="radio" class="radio-md" name="group2"/> <input type="radio" class="radio-lg" name="group2"/> <input type="radio" class="radio-xl" name="group2"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radio-sm" name="group3"/> <input type="radio" class="radio-indigo-md" name="group3"/> <input type="radio" class="radio-red-lg" name="group3"/> <input type="radio" class="radio-slate-xl" name="group3"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radiob-blue" name="group4"/> <input type="radio" class="radiob-amber" name="group4"/> <input type="radio" class="radiob-emerald" name="group4"/> <input type="radio" class="radiob" name="group4"/></div>');function ct(o){var e=it(),n=b(e);n.defaultChecked=!0;var t=l(n,14);t.defaultChecked=!0;var a=l(t,8);a.defaultChecked=!0;var r=l(a,14);r.defaultChecked=!0,m(e),s(o,e)}var dt=d('<div class="flex flex-gap3 flex-wrap items-center brd p5 rounded [&amp;>label]:mr3"><input type="radio" id="option1" name="group" class="radio"/> <label for="option1">Arch</label> <input type="radio" id="option2" name="group" class="radio"/> <label for="option2">Void</label> <input type="radio" id="option3" name="group" class="radiob"/> <label for="option3">Ubuntu</label> <input type="radio" id="option4" name="group" class="radiob"/> <label for="option4">Fedora</label></div>');function ut(o){var e=dt(),n=b(e);n.defaultChecked=!0,_(14),m(e),s(o,e)}var pt=d('<div class="flex brd p20 gap5 rounded-xl justify-center"><div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr] items-center"><input type="radio" id="email" name="x" class="radio"/> <label for="email">Email notifications</label> <input type="radio" id="sms" name="x" class="radio-blue"/> <div><label for="sms">SMS notifications</label><br/> <span class="text-mutedfg text-sm">Standard messaging rates may apply</span></div> <input type="radio" id="none" name="x" class="radio-slate"/> <label for="none">No notifications</label> <input type="radio" id="disagree" name="x" class="radio-red"/> <label for="disagree">Stop Bothering!</label></div></div>');function mt(o){var e=pt(),n=b(e),t=b(n);t.defaultChecked=!0,_(14),m(n),m(e),s(o,e)}var bt=d('<div class="flex flex-gap3 flex-wrap justify-center brd p10 py20 rounded"><div class="grid grid-cols-2 grid-gap3 w-2/3"><!> <!> <!> <!></div></div>');function vt(o){const e=[{value:"1",name:"Option 1"},{value:"2",name:"Option 2"},{value:"3",name:"Option 3"},{value:"4",name:"Option 4"},{value:"5",name:"Option 5 keyboad hehe"}],n=[{value:"apple",name:"Apple ",iconL:"i-noto:red-apple"},{value:"lime",name:"Lime",iconL:"i-noto:lime"},{value:"watermelon",name:"Watermelon",iconL:"i-noto:watermelon"},{value:"strawberry",name:"Strawberry",iconL:"i-noto:strawberry"},{value:"mango",name:"Mango",iconL:"i-noto:mango"}],t=[{value:"arch",name:"Arch Linux ",iconL:"i-logos:archlinux"},{value:"ubuntu",name:"Ubuntu",iconL:"i-logos:ubuntu"},{value:"fedora",name:"Fedora",iconL:"i-logos:fedora"},{value:"manjaro",name:"Manjaro",iconL:"i-logos:manjaro"},{value:"artix",name:"Artix ",iconL:"i-devicon:artixlinux"}];var a=bt(),r=b(a),i=b(r);ae(i,{get options(){return e},dropdownCss:"bg-mutedbg border-0",optionCss:"data-active:bg-input"});var c=l(i,2);ae(c,{get options(){return n},triggerProps:{class:"btn-outline"},placeholder:"Select fruit"});var f=l(c,2);ae(f,{get options(){return n},triggerProps:{class:"btn-outline",disabled:!0},placeholder:"Disabled Select"});var g=l(f,2);ae(g,{get options(){return t},placeholder:"Select distro",optinCss:"gap4"}),m(r),m(a),s(o,a)}var ft=d('<div class="flex flex-wrap gap-y-3 gap-x-6 items-center brd p5 rounded"><input type="checkbox" class="switch"/> <input type="checkbox" class="switch-flat-md-primary"/> <input type="checkbox" class="switch-flat-md-red"/> <input type="checkbox" class="switch-flat-md-amber4"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-flat-xs"/> <input type="checkbox" class="switch-flat-sm"/> <input type="checkbox" class="switch-flat-md"/> <input type="checkbox" class="switch-flat-lg"/> <input type="checkbox" class="switch-flat-xl"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-flat-xs"/> <input type="checkbox" class="switch-line-sm"/> <input type="checkbox" class="switch-line-md-indigo"/> <input type="checkbox" class="switch-line-lg-red"/> <input type="checkbox" class="switch-line-xl-slate"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-knob-md-blue"/> <input type="checkbox" class="switch-knob-md-amber"/> <input type="checkbox" class="switch-flat-md-emerald"/> <input type="checkbox" class="switch-knob" name="group4"/></div>');function ht(o){var e=ft(),n=b(e);n.defaultChecked=!0;var t=l(n,16);t.defaultChecked=!0;var a=l(t,10);a.defaultChecked=!0;var r=l(a,2);r.defaultChecked=!0;var i=l(r,2);i.defaultChecked=!0;var c=l(i,10);c.defaultChecked=!0,m(e),s(o,e)}var gt=d('<div class="flex flex-gap5 flex-wrap items-center brd p5 rounded"><input type="checkbox" class="switch-line"/> <input type="checkbox" class="switch-flat"/> <input type="checkbox" class="switch-knob"/></div>');function xt(o){var e=gt(),n=l(b(e),2);n.defaultChecked=!0,_(2),m(e),s(o,e)}var _t=d('<div class="flex brd p20 gap5 rounded-xl justify-center"><div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr] items-center"><input type="checkbox" id="email" class="switch-line"/> <label for="email">Email notifications</label> <input type="checkbox" id="sms" class="switch-line"/> <div><label for="sms">SMS notifications</label><br/> <span class="text-mutedfg text-sm">Standard messaging rates may apply</span></div> <input type="checkbox" id="none" class="switch"/> <label for="none">No notifications</label> <input type="checkbox" id="disagree" class="switch"/> <label for="disagree">Stop Bothering!</label></div></div>');function yt(o){var e=_t(),n=b(e),t=b(n);t.defaultChecked=!0,_(14),m(n),m(e),s(o,e)}const wt=`import { Btn } from "@haze-ui/react";
...
`,Tt=`<div class="flex brd p20 rounded-xl justify-center">
  <div
