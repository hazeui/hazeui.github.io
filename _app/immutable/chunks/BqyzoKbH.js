import"./DsnmJJEf.js";import{a4 as Rs,k as Ms,a5 as Vs,o as Ws,aV as Hs,p as u,aq as G,a as y,b as e,c as L,f as l,d as P,s as c,r as F,t as B,g as N,al as V,am as hs,ac as D,ab as vs,aK as Ds,aI as ss,j as $s,aD as Ls,n as w,e as M}from"./BCwpZRLA.js";import{a as H,e as Ks,d as U,s as fs,o as Ts,m as Gs}from"./CLnk85e-.js";import{p as d,i as A,r as es,s as Is}from"./PsfHwgad.js";import{b as v,c as Js}from"./Zm7-z96k.js";import{d as Qs,s as E,r as Xs,a as ys,c as W,b as Q}from"./DS9aIEHG.js";import"./69_IOA4Y.js";import{B as K}from"./DerTaunq.js";import{e as Bs}from"./CTWaMmW5.js";import{i as Ns}from"./DdJ5fWqL.js";function Ss(p,s,a){Rs(()=>{var n=Ms(()=>s(p,a?.())||{});if(a&&n?.update){var t=!1,r={};Vs(()=>{var i=a();Ws(i),t&&Hs(r,i)&&(r=i,n.update(i))}),t=!0}if(n?.destroy)return()=>n.destroy()})}const xs=p=>p?typeof p=="string"?document.querySelector(p):p:null;function Ys(p,s="body"){return xs(s)?.appendChild(p),{update:a=>{a!==s&&(p.parentNode?.removeChild(p),xs(a)?.appendChild(p))},destroy:()=>{p.parentNode?.removeChild(p)}}}const Zs=p=>{p.currentTarget==p.target&&close()};var sa=l('<button class="i-pajamas:close absolute right-4 top-4 focus:bg-red" aria-label="close" tabindex="-1"></button>'),aa=l('<dialog class="backdrop:bg-black/60"><div tabindex="-1"><!> <!></div></dialog>');function na(p,s){u(s,!0);let a=d(s,"closeIcon",3,!0);var n=G(),t=y(n);{var r=i=>{var o=aa();o.__click=[Zs];var q=P(o),f=P(q);{var b=S=>{var k=sa();k.__click=function(...C){s.close?.apply(this,C)},e(S,k)};A(f,S=>{a()&&S(b)})}var h=c(f,2);H(h,()=>s.children),F(q),F(o),Ss(o,S=>Ys?.(S)),Qs(o,()=>S=>S.showModal()),B(()=>E(q,1,`dialog ${s.class}`)),Ks("close",o,function(...S){s.close?.apply(this,S)}),e(i,o)};A(t,i=>{s.open&&i(r)})}e(p,n),L()}U(["click"]);var pa=l("<div></div>"),ta=l("<div></div>"),ea=l("<div><!> <input/> <!></div>");function X(p,s){u(s,!0);let a=d(s,"class",3,""),n=es(s,["$$slots","$$events","$$legacy","iconL","iconR","class"]);var t=ea(),r=P(t);{var i=b=>{var h=G(),S=y(h);{var k=g=>{var m=pa();B(()=>E(m,1,W(s.iconL))),e(g,m)},C=g=>{var m=G(),j=y(m);H(j,()=>s.iconL),e(g,m)};A(S,g=>{typeof s.iconL=="string"?g(k):g(C,!1)})}e(b,h)};A(r,b=>{s.iconL&&b(i)})}var o=c(r,2);Xs(o),ys(o,()=>({...n}));var q=c(o,2);{var f=b=>{var h=G(),S=y(h);{var k=g=>{var m=ta();B(()=>E(m,1,W(s.iconR))),e(g,m)},C=g=>{var m=G(),j=y(m);H(j,()=>s.iconR),e(g,m)};A(S,g=>{typeof s.iconR=="string"?g(k):g(C,!1)})}e(b,h)};A(q,b=>{s.iconR&&b(f)})}F(t),B(b=>E(t,1,b),[()=>W(a()?.includes("grinput")?a():`grinput ${a()}`)]),e(p,t),L()}const zs=(p,s)=>{function a(n){p.contains(n.target)||s()}return document.addEventListener("click",a),{destroy(){document.removeEventListener("click",a)}}};var la=()=>null,ca=l("<span></span>"),ra=l('<li role="option"><!> </li>'),ia=l('<ul role="listbox"></ul>'),oa=l('<div class="relative inline-flex first:children:w-full"><!> <!></div>');function os(p,s){u(s,!0);let a=d(s,"placeholder",3,"Select Option"),n=V(!1),t=V(-1),r=V(-1);const i=()=>{D(n,!N(n)),N(n)&&D(r,N(t),!0)},o=g=>{g!==N(t)&&(D(t,g,!0),s.onChange?.(s.options[g].value)),D(n,!1)},q=g=>{switch(g.preventDefault(),g.key){case"Enter":o(N(r));break;case"Escape":D(n,!1);break;case"ArrowUp":D(r,N(r)>0?N(r)-1:0,!0);break;case"ArrowDown":D(r,N(r)<s.options.length-1?N(r)+1:0,!0);break}},b=`justify-start btn-ghost-eqmd transition-none ${s.optionCss?.includes("data-")?s.optionCss:`data-active:bg-mutedbg ${s.optionCss}`}`;var h=oa(),S=P(h);{let g=hs(()=>s.options[N(t)]?.name||a());K(S,Is({"aria-haspopup":"listbox",get"aria-expanded"(){return N(n)},onclick:i,onkeydown:q,iconR:"ml-auto i-fa-solid:caret-down",get txt(){return N(g)}},()=>s.triggerProps))}var k=c(S,2);{var C=g=>{var m=ia();Q(m,"tabindex",-1),Bs(m,23,()=>s.options,j=>j.value,(j,T,O)=>{var $=ra();Q($,"tabindex",-1),$.__click=()=>o(N(O)),$.__keydown=[la];var R=P($);{var J=I=>{var x=ca();B(()=>E(x,1,W(N(T).iconL))),e(I,x)};A(R,I=>{N(T).iconL&&I(J)})}var _=c(R);F($),B(()=>{Q($,"id",`option-${N(O)}`),Q($,"aria-selected",N(t)===N(O)),Q($,"data-active",N(r)===N(O)),E($,1,W(b)),fs(_,` ${N(T).name??""}`)}),e(j,$)}),F(m),B(()=>{E(m,1,`popover z-10 whitespace-nowrap ${s.dropdownCss}`),Q(m,"aria-activedescendant",`option-${N(r)}`)}),e(g,m)};A(k,g=>{N(n)&&g(C)})}F(h),Ss(h,(g,m)=>zs?.(g,m),()=>()=>D(n,!1)),e(p,h),L()}U(["click","keydown"]);function ks(p,s){u(s,!0);let a=V(vs(s.defaultValue)),n=vs([]);const t=o=>D(a,o,!0);Ds("tabs",{value:()=>s.value??N(a),setValue:s.setValue??t,tabLabels:()=>n,addTabLabel:o=>n.push(o)});var r=G(),i=y(r);H(i,()=>s.children),e(p,r),L()}const ua=(p,s,a)=>s(a.value);var La=l('<button role="tab"><!></button>');function Z(p,s){u(s,!0);const{value:a,setValue:n,addTabLabel:t}=ss("tabs");Ts(()=>t(s.value));var r=La();r.__click=[ua,n,s];var i=P(r);H(i,()=>s.children),F(r),B(o=>Q(r,"aria-selected",o),[()=>a()==s.value]),e(p,r),L()}U(["click"]);var Na=l('<div role="tabpanel"><!></div>');function _s(p,s){u(s,!0);const{value:a}=ss("tabs");var n=G(),t=y(n);{var r=i=>{var o=Na(),q=P(o);H(q,()=>s.children),F(o),B(f=>Q(o,"aria-labelledby",f),[()=>`tab-${a()}`]),e(i,o)};A(t,i=>{a()==s.value&&i(r)})}e(p,n),L()}const da=(p,s,a,n)=>{p.key=="ArrowLeft"&&N(s)!=0?a(n()[N(s)-1]):p.key=="ArrowRight"&&N(s)!=n().length-1&&a(n()[N(s)+1])};var ga=l('<div role="tablist" tabindex="-1"><!></div>');function Fs(p,s){u(s,!0);const{value:a,tabLabels:n,setValue:t}=ss("tabs");let r=hs(()=>n().indexOf(a()));$s(()=>{a()||t(n()[0])});var i=ga();i.__keydown=[da,r,t,n];var o=P(i);H(o,()=>s.children),F(i),B(q=>E(i,1,q),[()=>W(s.class?.includes("tabs-")?s.class:`tabs ${s.class}`)]),e(p,i),L()}U(["keydown"]);var qa=l('<div class="relative inline-block"><!></div>');function Ps(p,s){u(s,!0);let a=V(!1);const n=()=>D(a,!N(a)),t=()=>D(a,!1);Ds("dropdown",{open:()=>N(a),toggleDropdown:n,closeDropdown:t});var i=qa(),o=P(i);H(o,()=>s.children??Ls),F(i),Ss(i,(q,f)=>zs?.(q,f),()=>t),e(p,i),L()}const ba=(p,s,a,n)=>{if(!s())return;const t=a();t.length!==0&&(p.key=="ArrowDown"&&N(n)<t.length?(p.preventDefault(),D(n,N(n)+1),t[N(n)]?.focus()):p.key=="ArrowUp"&&N(n)>0&&(D(n,N(n)-1),t[N(n)]?.focus()))};var ma=l('<div role="menu" tabindex="0"><!></div>');function js(p,s){u(s,!0);let a=d(s,"class",3,""),n=V(-1),t=V(null);const{open:r}=ss("dropdown"),i=()=>N(t)?Array.from(N(t).querySelectorAll('[role="menuitem"]')):[];$s(()=>{r()&&N(t)?.focus()});var o=G(),q=y(o);{var f=b=>{var h=ma();h.__keydown=[ba,r,i,n];var S=P(h);H(S,()=>s.children??Ls),F(h),v(h,k=>D(t,k),()=>N(t)),B(k=>E(h,1,k),[()=>W(a().includes("popover")?a():`popover ${a()}`)]),e(b,h)};A(q,b=>{r()&&b(f)})}e(p,o),L()}U(["keydown"]);var va=l("<button><!></button>");function Cs(p,s){u(s,!0);const{toggleDropdown:a}=ss("dropdown");let n=es(s,["$$slots","$$events","$$legacy","children","class"]);var t=va();ys(t,i=>({class:i,onclick:a,...n}),[()=>s.class?.includes("btn")?s.class:`btn ${s.class}`]);var r=P(t);H(r,()=>s.children??Ls),F(t),e(p,t),L()}var fa=l("<button><!></button>");function z(p,s){u(s,!0);let a=es(s,["$$slots","$$events","$$legacy","children","class"]);const{closeDropdown:n}=ss("dropdown");var t=fa();ys(t,()=>({onclick:n,class:`btn-ghost-eqmd focus:bg-input justify-start whitespace-nowrap ${s.class}`,role:"menuitem",...a}));var r=P(t);H(r,()=>s.children??Ls),F(t),e(p,t),L()}const ha=(p,s,a)=>Es(a.id,a.pos);var ya=l("<div></div>"),Sa=l('<div><!> <div class="grid gap1"><b> </b> <span> </span></div> <button aria-label="close" class="btn-ghost-eqsm absolute right-2 top-2"><span class="i-pajamas:close"></span></button></div>');function wa(p,s){u(s,!0);let a=d(s,"icon",15),n=d(s,"css",3,""),t=es(s,["$$slots","$$events","$$legacy","pos","icon","css"]);const r={success:"i-mingcute:check-circle-fill",warning:"i-jam:info-f",danger:"i-mi:circle-error"},i=n()?.match(/\b\S*toast\S*(danger|success|warning)\S*\b/);if(!a()&&i&&i[0]){const m=i[0].split("-");a(r[m.at(-1)])}Ts(()=>{setTimeout(()=>Es(s.id,s.pos),s.duration||3e3)});var o=Sa(),q=P(o);{var f=m=>{var j=ya();B(()=>E(j,1,a()+" my-auto text-3xl")),e(m,j)};A(q,m=>{a()&&m(f)})}var b=c(q,2),h=P(b),S=P(h,!0);F(h);var k=c(h,2),C=P(k,!0);F(k),F(b);var g=c(b,2);g.__click=[ha,t,s],F(o),B(m=>{E(o,1,m),fs(S,s.title),fs(C,s.txt)},[()=>W(n().includes("toast")?n():`toast ${n()}`)]),e(p,o),L()}U(["click"]);function xa(p,s){u(s,!0);var a=G(),n=y(a);Bs(n,17,()=>ts[s.pos],t=>t.id,(t,r)=>{wa(t,Is(()=>N(r)))}),e(p,a),L()}let ts=vs({topleft:[],topmid:[],topright:[],botleft:[],botmid:[],botright:[]});const ka=p=>{p.pos&&ts[p.pos].push({...p,id:crypto.randomUUID()})},Es=(p,s)=>{const a=ts[s].findIndex(n=>n.id===p);a!==-1&&ts[s].splice(a,1),ts[s].length==0&&document.getElementById("toasts-"+s)?.remove()},_a={topright:"top-3 right-3",topleft:"top-3 left-3",botleft:"bottom-3 left-3",botright:"bottom-3 right-3",topmid:"top-3 left-1/2 -translate-x-1/2",botmid:"bottom-3 left-1/2 -translate-x-1/2"},ds=p=>{p.pos=p.pos||"topmid";const s="toast-"+p.pos;let a=document.getElementById(s);a||(a=document.createElement("div"),a.id=s,a.className="fixed "+_a[p.pos],document.body.appendChild(a),Gs(xa,{target:a,props:{pos:p.pos}})),ka(p)},Fa=p=>p.replace(/^\s*\d+\s?/gm,""),Pa=(p,s,a)=>{const n=Fa(N(s).textContent);navigator.clipboard.writeText(n),D(a,!0),setTimeout(()=>{D(a,!1)},1e3)};var ja=l('<i class="i-mage:preview-fill"></i> Preview',1),Ca=l('<i class="i-majesticons:code"></i> Code',1),Da=l("<!> <!>",1),$a=l("<div><!></div>"),Ka=l('<i class="i-devicon:html5"></i> file.html',1),Ta=l('<i class="i-devicon:svelte"></i> Svelte',1),Ia=l('<i class="i-devicon:react"></i> React',1),Ba=l('<i class="i-devicon:solidjs"></i> Solid',1),za=l("<!> <!> <!>",1),Ea=l('<!> <button class="!rounded-full m-l-auto hover:text-primary" aria-label="Copy to clipboard"><i></i></button>',1),Oa=l('<!> <div class="bg-[#232b3d] dark:bg-[#121a2a] text-white pt5 rounded-b"><!></div>',1),Aa=l("<!> <!> <!>",1);function ie(p,s){u(s,!0);let a=V(void 0);const n=es(s,["$$slots","$$events","$$legacy"]);let{demo:t,class:r=""}=n,i=V(null);const o=b=>{D(i,b,!0)},q=t.preview;let f=V(!1);ks(p,{defaultValue:"preview",children:(b,h)=>{var S=Aa(),k=y(S);Fs(k,{class:"tabs w-fit p1 !children:p2 !children:px3",children:(m,j)=>{var T=Da(),O=y(T);Z(O,{value:"preview",children:(R,J)=>{var _=ja();w(),e(R,_)},$$slots:{default:!0}});var $=c(O,2);Z($,{value:"code",children:(R,J)=>{var _=Ca();w(),e(R,_)},$$slots:{default:!0}}),e(m,T)},$$slots:{default:!0}});var C=c(k,2);_s(C,{value:"preview",children:(m,j)=>{var T=$a(),O=P(T);q(O,{}),F(T),B($=>E(T,1,$),[()=>W(r.includes("demobox")?r:`demobox-center ${r}`)]),e(m,T)},$$slots:{default:!0}});var g=c(C,2);_s(g,{value:"code",children:(m,j)=>{ks(m,{get value(){return N(i)},setValue:o,children:(T,O)=>{var $=Oa(),R=y($);Fs(R,{class:"tabs-line-primary brd border-b-0 rounded-t [&>button]:capitalize",children:(x,gs)=>{var ls=Ea(),cs=y(ls);{var qs=Y=>{Z(Y,{value:"html",children:(rs,ms)=>{var is=Ka();w(),e(rs,is)},$$slots:{default:!0}})},bs=Y=>{var rs=za(),ms=y(rs);Z(ms,{value:"svelte",children:(ns,ws)=>{var ps=Ta();w(),e(ns,ps)},$$slots:{default:!0}});var is=c(ms,2);Z(is,{value:"react",children:(ns,ws)=>{var ps=Ia();w(),e(ns,ps)},$$slots:{default:!0}});var Us=c(is,2);Z(Us,{value:"solid",children:(ns,ws)=>{var ps=Ba();w(),e(ns,ps)},$$slots:{default:!0}}),e(Y,rs)};A(cs,Y=>{t.code.html?Y(qs):Y(bs,!1)})}var as=c(cs,2);as.__click=[Pa,a,f];var As=P(as);F(as),B(()=>E(As,1,W(N(f)?"i-line-md:confirm":"i-majesticons:clipboard-line"))),e(x,ls)},$$slots:{default:!0}});var J=c(R,2),_=P(J);{var I=x=>{var gs=G();const ls=hs(()=>t.code[N(i)]);var cs=y(gs);Js(cs,()=>N(ls),(qs,bs)=>{bs(qs,{get ref(){return N(a)},set ref(as){D(a,as,!0)}})}),e(x,gs)};A(_,x=>{N(i)&&t.code[N(i)]&&x(I)})}F(J),e(T,$)},$$slots:{default:!0}})},$$slots:{default:!0}}),e(b,S)},$$slots:{default:!0}}),L()}U(["click"]);var Ua=l('<span class="badge bg-indigo">Badge</span> <span class="badge-outline border-fg">Outline</span> <span class="badge-surface">Surface</span> <span class="badge dtxtbg-emerald-60"><i class="i-icon-park-outline:check-one"></i> Badge</span> <span class="badge bg-rose"><i class="i-line-md:star-filled"></i> Badge</span> <span class="badge ltxtbg-blue-80">Light blue</span> <span class="badge dtxtbgr-pink_3">Badge</span> <span class="badge ltxtbgr-orange">Badge</span> <span class="badge ltxtbg-emerald_5-80"><i class="i-icon-park-outline:check-one"></i> Badge</span>',1);function Ra(p){var s=Ua();w(16),e(p,s)}var Ma=l('<span class="badge-sm">Size sm</span> <span class="badge-secondary-md">Size md</span> <span class="badge-secondary-lg">Size lg</span> <span class="badge-surface-xl">Size xl</span>',1);function Va(p){var s=Ma();w(6),e(p,s)}var Wa=l('<span class="badge-solid">Badge</span> <span class="badge-secondary">Secondary</span> <span class="badge-outline">Outline</span> <span class="badge-surface">Surface</span> <span class="badge bg-emerald6"><i class="i-uil:check-circle"></i> Checked!</span> <span class="badge bg-amber6"><i class="i-line-md:star-filled"></i> 5.3k</span> <span class="badge-outline">99+</span>',1);function Ha(p){var s=Wa();w(12),e(p,s)}var Ga=l("<!> <!> <!>",1);function Ja(p){var s=Ga(),a=y(s);K(a,{class:"btn-success",txt:"Success"});var n=c(a,2);K(n,{class:"btn-warning",txt:"Warning"});var t=c(n,2);K(t,{class:"btn-danger",txt:"danger"}),e(p,s)}var Qa=l('<button class="btn-primary">Primary</button> <button class="btn-soft">Soft</button> <button class="btn-outline">Outline</button> <button class="btn-ghost">Ghost</button> <button class="btn-emerald5 text-white"><i class="i-line-md:email-filled"></i> Email</button> <button class="btn-outline btn"><i class="i-iconamoon:send"></i> Send us</button> <button class="btn-soft"><i class="i-eos-icons:loading"></i> Fetching...</button> <button class="btn-primary-eqmd" aria-label="plus button"><i class="i-tabler:plus"></i></button> <button class="btn-outline-eqmd rounded-full btn" aria-label="user button"><i class="i-iconoir:user"></i></button> <hr class="w-full brd mt3 mb1"/> <button class="btn-soft-xs">Button</button> <button class="btn-soft-sm">Button</button> <button class="btn-soft-md">Button</button> <button class="btn-soft-lg">Button</button> <button class="btn-soft-xl">Button</button>',1);function Xa(p){var s=Qa();w(28),e(p,s)}var Ya=l("<!> <!> <!> <!> <!>",1);function Za(p){var s=Ya(),a=y(s);K(a,{class:"btn-emerald5 text-white",iconL:"i-line-md:email-filled",txt:"Email"});var n=c(a,2);K(n,{iconL:"i-iconamoon:send",txt:"Send us",class:"btn-outline"});var t=c(n,2);K(t,{loading:!0,loaderTxt:"Fetching...",disabled:!0,txt:"Fetch data"});var r=c(t,2);K(r,{iconL:"i-tabler:plus",class:"btn-primary-eqmd","aria-label":"plus button"});var i=c(r,2);K(i,{iconL:"i-iconoir:user",class:"btn-outline-eqmd rounded-full","aria-label":"user button"}),e(p,s)}var sn=l("<!> <!> <!> <!> <!>",1);function an(p){var s=sn(),a=y(s);K(a,{class:"btn-soft-xs",txt:"Success"});var n=c(a,2);K(n,{class:"btn-soft-sm",txt:"Success"});var t=c(n,2);K(t,{class:"btn-soft-md",txt:"Success"});var r=c(t,2);K(r,{class:"btn-soft-lg",txt:"Success"});var i=c(r,2);K(i,{class:"btn-soft-xl",txt:"Success"}),e(p,s)}var nn=l("<!> <!> <!> <!>",1);function pn(p){var s=nn(),a=y(s);K(a,{txt:"Primary",class:"btn-primary"});var n=c(a,2);K(n,{class:"soft",txt:"Soft"});var t=c(n,2);K(t,{class:"btn-outline",txt:"Outline"});var r=c(t,2);K(r,{class:"btn-ghost",txt:"Ghost"}),e(p,s)}var tn=l('<input type="checkbox" class="checkbox"/> <input type="checkbox" class="checkbox-primary"/> <input type="checkbox" class="checkbox-red"/> <input type="checkbox" class="checkbox-amber4"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-sm"/> <input type="checkbox" class="checkbox-md"/> <input type="checkbox" class="checkbox-lg"/> <input type="checkbox" class="checkbox-xl"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-sm"/> <input type="checkbox" class="checkbox-indigo-md"/> <input type="checkbox" class="checkbox-red-lg"/> <input type="checkbox" class="checkbox-slate-xl"/> <input type="checkbox" class="checkbox-xl !after:checked:i-ph:check-fat-fill !after:checked:size-6"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="checkbox-blue text-white"/> <input type="checkbox" class="checkbox-amber text-amber8"/> <input type="checkbox" class="checkbox-emerald"/> <input type="checkbox" class="checkbox checked:bg-bg text-fg"/>',1);function en(p){var s=tn(),a=c(y(s),2);a.defaultChecked=!0;var n=c(a,2);n.defaultChecked=!0;var t=c(n,2);t.defaultChecked=!0;var r=c(t,4);r.defaultChecked=!0;var i=c(r,2);i.defaultChecked=!0;var o=c(i,2);o.defaultChecked=!0;var q=c(o,2);q.defaultChecked=!0;var f=c(q,4);f.defaultChecked=!0;var b=c(f,2);b.defaultChecked=!0;var h=c(b,2);h.defaultChecked=!0;var S=c(h,2);S.defaultChecked=!0;var k=c(S,2);k.defaultChecked=!0;var C=c(k,4);C.defaultChecked=!0;var g=c(C,2);g.defaultChecked=!0;var m=c(g,2);m.defaultChecked=!0;var j=c(m,2);j.defaultChecked=!0,e(p,s)}var ln=l('<input type="checkbox" id="option" class="checkbox-fg"/> <label for="option">Option</label>',1);function cn(p){var s=ln(),a=y(s);a.defaultChecked=!0,w(2),e(p,s)}var rn=l('<div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr]"><input type="checkbox" id="tnc" class="checkbox"/> <label for="tnc">I agree to the Terms and Conditions</label> <input type="checkbox" id="tnc2" class="checkbox-blue"/> <div><label for="tnc2">I understand and read the privacy policy</label> <br/> <span class="text-mutedfg text-sm">By Agreeing you accept our <a class="link" href="/">Privacy Policy</a></span></div> <input type="checkbox" id="tnc3" class="checkbox-slate" disabled/> <label for="tnc3" class="muted-70">I have freedom of speech</label></div>');function on(p){var s=rn(),a=P(s);a.defaultChecked=!0;var n=c(a,4);n.defaultChecked=!0,w(6),F(s),e(p,s)}const un=(p,s)=>D(s,!0);var Ln=l('<h3>Edit Account</h3> <p class="text-mutedfg mb2">Make changes to your user profile here.</p> <label for="name">Name</label> <input class="input-outline" id="name" placeholder="Enter your name"/> <label for="email">Email</label> <input type="email" class="input-outline" id="email" placeholder="Enter your email"/> <div class="flex gap3 items-center ml-auto mt3"><button class="btn-soft">Cancel</button> <button class="btn-primary">Save</button></div>',1),Nn=l('<button class="btn-primary mx-auto">Open</button> <!>',1);function dn(p){let s=V(!1);const a=()=>D(s,!1);var n=Nn(),t=y(n);t.__click=[un,s];var r=c(t,2);na(r,{get open(){return N(s)},close:a,class:"grid gap4",children:(i,o)=>{var q=Ln(),f=c(y(q),12),b=P(f);b.__click=a,w(2),F(f),e(i,q)},$$slots:{default:!0}}),e(p,n)}U(["click"]);var gn=l('<!> <!> <!> <!> <hr class="brd my1"/> <!> <!> <!> <hr class="brd my1"/> <!> <!> <!> <hr class="brd my1"/> <!>',1),qn=l("<!> <!>",1),bn=l('<i class="i-line-md:star-filled"></i> With icons',1),mn=l('<i class="i-line-md:account"></i>Profile',1),vn=l('<i class="i-nimbus:cog"></i>Settings',1),fn=l('<i class="i-line-md:logout"></i>Log out',1),hn=l("<!> <!> <!>",1),yn=l("<!> <!>",1),Sn=l("<!> <!>",1);function wn(p){var s=Sn(),a=y(s);Ps(a,{children:(t,r)=>{var i=qn(),o=y(i);Cs(o,{class:"btn-primary",children:(f,b)=>{w();var h=M("Click me");e(f,h)},$$slots:{default:!0}});var q=c(o,2);js(q,{children:(f,b)=>{var h=gn(),S=y(h);z(S,{children:(_,I)=>{w();var x=M("Profile");e(_,x)},$$slots:{default:!0}});var k=c(S,2);z(k,{children:(_,I)=>{w();var x=M("Billing");e(_,x)},$$slots:{default:!0}});var C=c(k,2);z(C,{children:(_,I)=>{w();var x=M("Settings");e(_,x)},$$slots:{default:!0}});var g=c(C,2);z(g,{children:(_,I)=>{w();var x=M("Keyboard shortcuts");e(_,x)},$$slots:{default:!0}});var m=c(g,4);z(m,{children:(_,I)=>{w();var x=M("Team");e(_,x)},$$slots:{default:!0}});var j=c(m,2);z(j,{children:(_,I)=>{w();var x=M("Invite users");e(_,x)},$$slots:{default:!0}});var T=c(j,2);z(T,{children:(_,I)=>{w();var x=M("New Team");e(_,x)},$$slots:{default:!0}});var O=c(T,4);z(O,{children:(_,I)=>{w();var x=M("GitHub");e(_,x)},$$slots:{default:!0}});var $=c(O,2);z($,{children:(_,I)=>{w();var x=M("Support");e(_,x)},$$slots:{default:!0}});var R=c($,2);z(R,{disabled:!0,children:(_,I)=>{w();var x=M("API");e(_,x)},$$slots:{default:!0}});var J=c(R,4);z(J,{children:(_,I)=>{w();var x=M("Log out");e(_,x)},$$slots:{default:!0}}),e(f,h)},$$slots:{default:!0}}),e(t,i)},$$slots:{default:!0}});var n=c(a,2);Ps(n,{children:(t,r)=>{var i=yn(),o=y(i);Cs(o,{class:"btn-soft",children:(f,b)=>{var h=bn();w(),e(f,h)},$$slots:{default:!0}});var q=c(o,2);js(q,{children:(f,b)=>{var h=hn(),S=y(h);z(S,{children:(g,m)=>{var j=mn();w(),e(g,j)},$$slots:{default:!0}});var k=c(S,2);z(k,{children:(g,m)=>{var j=vn();w(),e(g,j)},$$slots:{default:!0}});var C=c(k,2);z(C,{children:(g,m)=>{var j=fn();w(),e(g,j)},$$slots:{default:!0}}),e(f,h)},$$slots:{default:!0}}),e(t,i)},$$slots:{default:!0}}),e(p,s)}const xn=(p,s)=>{D(s,N(s)==="text"?"password":"text",!0)};var kn=l('<button type="button" class="btn-ghost-eqsm rounded-full mr--2" aria-label="Toggle password visibility"><i></i></button>'),_n=l('<form class="grid gap3"><label for="email" class="reqstar">Email</label> <!> <label for="passwd">Password</label> <!> <input type="submit" class="!btn-primary ml-auto mt3"/></form>');function Fn(p,s){u(s,!0);let a=V("password");const n=o=>{o.preventDefault();const q=new FormData(o.target),f=q.get("email"),b=q.get("passwd");alert(`
Email: ${f}
Password: ${b}`)};var t=_n(),r=c(P(t),2);X(r,{required:!0,name:"email",id:"email",placeholder:"Enter email",type:"email",iconL:"i-line-md:email",class:"grinput-outline mb3"});var i=c(r,4);X(i,{name:"passwd",id:"passwd",placeholder:"Enter Password",get type(){return N(a)},iconL:"i-lucide:key-round",class:"grinput-outline",iconR:q=>{var f=kn();f.__click=[xn,a];var b=P(f);F(f),B(()=>E(b,1,W(N(a)=="text"?"i-heroicons-solid:eye":"i-heroicons-solid:eye-off"))),e(q,f)},$$slots:{iconR:!0}}),w(2),F(t),Ks("submit",t,n),e(p,t),L()}U(["click"]);var Pn=l('<input class="input" placeholder="Enter name"/> <input class="input-outline" placeholder="Enter name"/> <br/> <p>sizes</p> <input class="input-outline-sm" placeholder="Enter name"/> <input class="input-outline-md" disabled placeholder="Enter name"/> <input class="input-lg" placeholder="Enter name"/> <input class="input-outline-xl" placeholder="Enter name"/> <p>Icons</p> <div class="grid grid-cols-2 grid-gap5"><div class="grinput"><i class="i-ri:user-line"></i> <input placeholder="Enter name"/></div> <div class="grinput-outline"><i class="i-line-md:email-filled"></i> <input placeholder="Enter name"/></div> <div class="grinput p0"><span class="bg-border p2 px3 rounded-l">$</span> <input placeholder="Enter price" type="number"/></div> <div class="grinput p0"><span class="bg-border p2 px3 rounded-l">$</span> <input placeholder="Enter salary" disabled/></div> <div class="grinput-outline p0 col-span-2"><span class="bg-mutedbg p2 px3 rounded-l">$</span> <input placeholder="Enter name"/> <span class="bg-mutedbg p2 rounded-r">USD</span></div></div>',1);function jn(p){var s=Pn();w(18),e(p,s)}var Cn=l("<!> <!> <!> <!>",1);function Dn(p){var s=Cn(),a=y(s);X(a,{placeholder:"size (sm)",class:"grinput-sm"});var n=c(a,2);X(n,{placeholder:"size (md)",class:"grinput-md"});var t=c(n,2);X(t,{placeholder:"size (lg)",class:"grinput-lg"});var r=c(t,2);X(r,{placeholder:"size (xl)",class:"grinput-outline-xl"}),e(p,s)}var $n=l("<!> <!>",1);function Kn(p){var s=$n(),a=y(s);X(a,{placeholder:"Enter name"});var n=c(a,2);X(n,{placeholder:"Enter name",class:"grinput-outline"}),e(p,s)}var Tn=l('<input type="radio" class="radio" name="group1"/> <input type="radio" class="radio-primary" name="group1"/> <input type="radio" class="radio-red" name="group1"/> <input type="radio" class="radio-amber4" name="group1"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radio-sm" name="group2"/> <input type="radio" class="radio-md" name="group2"/> <input type="radio" class="radio-lg" name="group2"/> <input type="radio" class="radio-xl" name="group2"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radio-sm" name="group3"/> <input type="radio" class="radio-indigo-md" name="group3"/> <input type="radio" class="radio-red-lg" name="group3"/> <input type="radio" class="radio-slate-xl" name="group3"/> <hr class="w-full brd border-input my2"/> <input type="radio" class="radiob-blue" name="group4"/> <input type="radio" class="radiob-amber" name="group4"/> <input type="radio" class="radiob-emerald" name="group4"/> <input type="radio" class="radiob" name="group4"/>',1);function In(p){var s=Tn(),a=y(s);a.defaultChecked=!0;var n=c(a,14);n.defaultChecked=!0;var t=c(n,8);t.defaultChecked=!0;var r=c(t,14);r.defaultChecked=!0,e(p,s)}var Bn=l('<input type="radio" id="option1" name="group" class="radio"/> <label for="option1">Arch</label> <input type="radio" id="option2" name="group" class="radio"/> <label for="option2">Void</label> <input type="radio" id="option3" name="group" class="radiob"/> <label for="option3">Ubuntu</label> <input type="radio" id="option4" name="group" class="radiob"/> <label for="option4">Fedora</label>',1);function zn(p){var s=Bn(),a=y(s);a.defaultChecked=!0,w(14),e(p,s)}var En=l('<div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr] items-center"><input type="radio" id="email" name="x" class="radio"/> <label for="email">Email notifications</label> <input type="radio" id="sms" name="x" class="radio-blue"/> <div><label for="sms">SMS notifications</label><br/> <span class="text-mutedfg text-sm">Standard messaging rates may apply</span></div> <input type="radio" id="none" name="x" class="radio-slate"/> <label for="none">No notifications</label> <input type="radio" id="disagree" name="x" class="radio-red"/> <label for="disagree">Stop Bothering!</label></div>');function On(p){var s=En(),a=P(s);a.defaultChecked=!0,w(14),F(s),e(p,s)}var An=l('<div class="grid grid-cols-2 grid-gap3 w-2/3"><!> <!> <!> <!></div>');function Un(p){const s=[{value:"1",name:"Option 1"},{value:"2",name:"Option 2"},{value:"3",name:"Option 3"},{value:"4",name:"Option 4"},{value:"5",name:"Option 5 keyboad hehe"}],a=[{value:"apple",name:"Apple ",iconL:"i-noto:red-apple"},{value:"lime",name:"Lime",iconL:"i-noto:lime"},{value:"watermelon",name:"Watermelon",iconL:"i-noto:watermelon"},{value:"strawberry",name:"Strawberry",iconL:"i-noto:strawberry"},{value:"mango",name:"Mango",iconL:"i-noto:mango"}],n=[{value:"arch",name:"Arch Linux ",iconL:"i-logos:archlinux"},{value:"ubuntu",name:"Ubuntu",iconL:"i-logos:ubuntu"},{value:"fedora",name:"Fedora",iconL:"i-logos:fedora"},{value:"manjaro",name:"Manjaro",iconL:"i-logos:manjaro"},{value:"artix",name:"Artix ",iconL:"i-devicon:artixlinux"}];var t=An(),r=P(t);os(r,{get options(){return s},dropdownCss:"bg-mutedbg border-0",optionCss:"data-active:bg-input"});var i=c(r,2);os(i,{get options(){return a},triggerProps:{class:"btn-outline"},placeholder:"Select fruit"});var o=c(i,2);os(o,{get options(){return a},triggerProps:{class:"btn-outline",disabled:!0},placeholder:"Disabled Select"});var q=c(o,2);os(q,{get options(){return n},placeholder:"Select distro",optinCss:"gap4"}),F(t),e(p,t)}var Rn=l('<input type="checkbox" class="switch"/> <input type="checkbox" class="switch-flat-md-primary"/> <input type="checkbox" class="switch-flat-md-red"/> <input type="checkbox" class="switch-flat-md-amber4"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-flat-xs"/> <input type="checkbox" class="switch-flat-sm"/> <input type="checkbox" class="switch-flat-md"/> <input type="checkbox" class="switch-flat-lg"/> <input type="checkbox" class="switch-flat-xl"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-flat-xs"/> <input type="checkbox" class="switch-line-sm"/> <input type="checkbox" class="switch-line-md-indigo"/> <input type="checkbox" class="switch-line-lg-red"/> <input type="checkbox" class="switch-line-xl-slate"/> <hr class="w-full brd border-input my2"/> <input type="checkbox" class="switch-knob-md-blue"/> <input type="checkbox" class="switch-knob-md-amber"/> <input type="checkbox" class="switch-flat-md-emerald"/> <input type="checkbox" class="switch-knob" name="group4"/>',1);function Mn(p){var s=Rn(),a=y(s);a.defaultChecked=!0;var n=c(a,16);n.defaultChecked=!0;var t=c(n,10);t.defaultChecked=!0;var r=c(t,2);r.defaultChecked=!0;var i=c(r,2);i.defaultChecked=!0;var o=c(i,10);o.defaultChecked=!0,e(p,s)}var Vn=l('<input type="checkbox" class="switch-line"/> <input type="checkbox" class="switch-flat"/> <input type="checkbox" class="switch-knob"/>',1);function Wn(p){var s=Vn(),a=c(y(s),2);a.defaultChecked=!0,w(2),e(p,s)}var Hn=l('<div class="[&amp;>*:nth-child(even)]:ml3 gap-x3 gap-y7 grid grid-cols-[auto_1fr] items-center"><input type="checkbox" id="email" class="switch-line"/> <label for="email">Email notifications</label> <input type="checkbox" id="sms" class="switch-line"/> <div><label for="sms">SMS notifications</label><br/> <span class="text-mutedfg text-sm">Standard messaging rates may apply</span></div> <input type="checkbox" id="none" class="switch"/> <label for="none">No notifications</label> <input type="checkbox" id="disagree" class="switch"/> <label for="disagree">Stop Bothering!</label></div>');function Gn(p){var s=Hn(),a=P(s);a.defaultChecked=!0,w(14),F(s),e(p,s)}var Jn=(p,s)=>s("toast-flat-indigo"),Qn=(p,s)=>s("toast-flat-sky"),Xn=(p,s)=>s("toast-flat-danger"),Yn=(p,s)=>s("toast-flat-success"),Zn=(p,s)=>s("toast-flat-warning"),sp=(p,s)=>s("toast-outline-indigo"),ap=(p,s)=>s("toast-outline-sky"),np=(p,s)=>s("toast-outline-danger"),pp=(p,s)=>s("toast-outline-success"),tp=(p,s)=>s("toast-outline-warning"),ep=l('<button class="btn-outline text-indigo">Indigo</button> <button class="btn-outline text-sky">Sky</button> <button class="btn-outline text-danger">Danger</button> <button class="btn-outline text-success">Success</button> <button class="btn-outline text-warning">Warning</button> <hr class="brd w-full my2"/> <button class="btn-outline text-indigo">Indigo</button> <button class="btn-outline text-sky">Sky</button> <button class="btn-outline text-danger">Danger</button> <button class="btn-outline text-success">Success</button> <button class="btn-outline text-warning">Warning</button>',1);function lp(p,s){u(s,!1);const a=C=>{ds({title:"Toast Activated",txt:"Customize this text to suit your message",css:C})};Ns();var n=ep(),t=y(n);t.__click=[Jn,a];var r=c(t,2);r.__click=[Qn,a];var i=c(r,2);i.__click=[Xn,a];var o=c(i,2);o.__click=[Yn,a];var q=c(o,2);q.__click=[Zn,a];var f=c(q,4);f.__click=[sp,a];var b=c(f,2);b.__click=[ap,a];var h=c(b,2);h.__click=[np,a];var S=c(h,2);S.__click=[pp,a];var k=c(S,2);k.__click=[tp,a],e(p,n),L()}U(["click"]);var cp=(p,s)=>s("topleft"),rp=(p,s)=>s("topmid"),ip=(p,s)=>s("topright"),op=(p,s)=>s("botleft"),up=(p,s)=>s("botmid"),Lp=(p,s)=>s("botright"),Np=l('<button class="btn">Top left</button> <button class="btn">Top center</button> <button class="btn">Top right</button> <button class="btn">Bottom left</button> <button class="btn">Bottom center</button> <button class="btn">Bottom right</button>',1);function dp(p,s){u(s,!1);const a=b=>{ds({title:"Toast Activated",txt:"Customize this text to suit your message",pos:b})};Ns();var n=Np(),t=y(n);t.__click=[cp,a];var r=c(t,2);r.__click=[rp,a];var i=c(r,2);i.__click=[ip,a];var o=c(i,2);o.__click=[op,a];var q=c(o,2);q.__click=[up,a];var f=c(q,2);f.__click=[Lp,a],e(p,n),L()}U(["click"]);const gp=()=>{ds({title:"Toast Activated",txt:"Customize this text to suit your message"})};var qp=l('<button class="btn">Show toast</button>');function bp(p,s){u(s,!1),Ns();var a=qp();a.__click=[gp],e(p,a),L()}U(["click"]);var mp=(p,s)=>s("toast-solid"),vp=(p,s)=>s("toast-flat"),fp=(p,s)=>s("toast-outline"),hp=l('<button class="btn-primary">Solid</button> <button class="btn">Flat</button> <button class="btn-outline">Outline</button>',1);function yp(p,s){u(s,!1);const a=o=>{ds({title:"Toast Activated",txt:"Customize this text to suit your message",css:o})};Ns();var n=hp(),t=y(n);t.__click=[mp,a];var r=c(t,2);r.__click=[vp,a];var i=c(r,2);i.__click=[fp,a],e(p,n),L()}U(["click"]);var Sp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;span class=&quot;badge bg-indigo&quot;&gt;Badge&lt;/span&gt;
...
</pre>`);function wp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Sp();v(n,t=>a(t),()=>a()),e(p,n),L()}var xp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;span class=&quot;badge-sm&quot;&gt;Size sm&lt;/span&gt;
...
</pre>`);function kp(p,s){u(s,!0);let a=d(s,"ref",15);var n=xp();v(n,t=>a(t),()=>a()),e(p,n),L()}var _p=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;span class=&quot;badge-solid&quot;&gt;Badge&lt;/span&gt;
...
</pre>`);function Fp(p,s){u(s,!0);let a=d(s,"ref",15);var n=_p();v(n,t=>a(t),()=>a()),e(p,n),L()}var Pp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Btn <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
...
</pre>`);function jp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Pp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Cp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
...
</pre>`);function Dp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Cp();v(n,t=>a(t),()=>a()),e(p,n),L()}var $p=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;button class=&quot;btn-primary&quot;&gt;Primary&lt;/button&gt;
...
</pre>`);function Kp(p,s){u(s,!0);let a=d(s,"ref",15);var n=$p();v(n,t=>a(t),()=>a()),e(p,n),L()}var Tp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Btn <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">export</span> <span class="Label">default</span> <span class="javaScriptParens">()</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  <span class="Statement">return</span> <span class="javaScriptParens">(</span>
<span class="LineNr">  </span><span class="LineNr">  5 </span>    &lt;&gt;
...
</pre>`);function Ip(p,s){u(s,!0);let a=d(s,"ref",15);var n=Tp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Bp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; Btn &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&lt;/script&gt;
<span class="LineNr">  </span><span class="LineNr">  4 </span>
...
</pre>`);function zp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Bp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Ep=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Btn <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">export</span> <span class="Label">default</span> <span class="javaScriptParens">()</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  <span class="Statement">return</span> <span class="javaScriptParens">(</span>
<span class="LineNr">  </span><span class="LineNr">  5 </span>    &lt;&gt;
...
</pre>`);function Op(p,s){u(s,!0);let a=d(s,"ref",15);var n=Ep();v(n,t=>a(t),()=>a()),e(p,n),L()}var Ap=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; Btn &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&lt;/script&gt;
<span class="LineNr">  </span><span class="LineNr">  4 </span>
...
</pre>`);function Up(p,s){u(s,!0);let a=d(s,"ref",15);var n=Ap();v(n,t=>a(t),()=>a()),e(p,n),L()}var Rp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Btn <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">export</span> <span class="Label">default</span> <span class="javaScriptParens">()</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  <span class="Statement">return</span> <span class="javaScriptParens">(</span>
<span class="LineNr">  </span><span class="LineNr">  5 </span>    &lt;&gt;
...
</pre>`);function Mp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Rp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Vp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; Btn &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&lt;/script&gt;
<span class="LineNr">  </span><span class="LineNr">  4 </span>
...
</pre>`);function Wp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Vp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Hp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;checkbox&quot; class=&quot;checkbox&quot; /&gt;
...
</pre>`);function Gp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Hp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Jp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;checkbox&quot; id=&quot;option&quot; class=&quot;checkbox-fg&quot; defaultChecked /&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>&lt;label for=&quot;option&quot;&gt;Option&lt;/label&gt;

</pre>`);function Qp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Jp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Xp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;div
...
</pre>`);function Yp(p,s){u(s,!0);let a=d(s,"ref",15);var n=Xp();v(n,t=>a(t),()=>a()),e(p,n),L()}var Zp=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> useState <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;react&quot;</span>;
...
</pre>`);function st(p,s){u(s,!0);let a=d(s,"ref",15);var n=Zp();v(n,t=>a(t),()=>a()),e(p,n),L()}var at=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
...
</pre>`);function nt(p,s){u(s,!0);let a=d(s,"ref",15);var n=at();v(n,t=>a(t),()=>a()),e(p,n),L()}var pt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span>
...
</pre>`);function tt(p,s){u(s,!0);let a=d(s,"ref",15);var n=pt();v(n,t=>a(t),()=>a()),e(p,n),L()}var et=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
...
</pre>`);function lt(p,s){u(s,!0);let a=d(s,"ref",15);var n=et();v(n,t=>a(t),()=>a()),e(p,n),L()}var ct=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Input <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
...
</pre>`);function rt(p,s){u(s,!0);let a=d(s,"ref",15);var n=ct();v(n,t=>a(t),()=>a()),e(p,n),L()}var it=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
...
</pre>`);function ot(p,s){u(s,!0);let a=d(s,"ref",15);var n=it();v(n,t=>a(t),()=>a()),e(p,n),L()}var ut=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input class=&quot;input&quot; placeholder=&quot;Enter name&quot; /&gt;
...
</pre>`);function Lt(p,s){u(s,!0);let a=d(s,"ref",15);var n=ut();v(n,t=>a(t),()=>a()),e(p,n),L()}var Nt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Input <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">export</span> <span class="Label">default</span> <span class="javaScriptParens">()</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  <span class="Statement">return</span> <span class="javaScriptParens">(</span>
...
</pre>`);function dt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Nt();v(n,t=>a(t),()=>a()),e(p,n),L()}var gt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; Input &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&lt;/script&gt;
<span class="LineNr">  </span><span class="LineNr">  4 </span>
...
</pre>`);function qt(p,s){u(s,!0);let a=d(s,"ref",15);var n=gt();v(n,t=>a(t),()=>a()),e(p,n),L()}var bt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Input <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">export</span> <span class="Label">default</span> <span class="javaScriptParens">()</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  <span class="Statement">return</span> <span class="javaScriptParens">(</span>
<span class="LineNr">  </span><span class="LineNr">  5 </span>    &lt;div&gt;
...
</pre>`);function mt(p,s){u(s,!0);let a=d(s,"ref",15);var n=bt();v(n,t=>a(t),()=>a()),e(p,n),L()}var vt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; Input &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&lt;/script&gt;
<span class="LineNr">  </span><span class="LineNr">  4 </span>
...
</pre>`);function ft(p,s){u(s,!0);let a=d(s,"ref",15);var n=vt();v(n,t=>a(t),()=>a()),e(p,n),L()}var ht=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;radio&quot; class=&quot;radio&quot; name=&quot;group1&quot; defaultChecked /&gt;
...
</pre>`);function yt(p,s){u(s,!0);let a=d(s,"ref",15);var n=ht();v(n,t=>a(t),()=>a()),e(p,n),L()}var St=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;radio&quot; id=&quot;option1&quot; name=&quot;group&quot; class=&quot;radio&quot; defaultChecked /&gt;
...
</pre>`);function wt(p,s){u(s,!0);let a=d(s,"ref",15);var n=St();v(n,t=>a(t),()=>a()),e(p,n),L()}var xt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;div
...
</pre>`);function kt(p,s){u(s,!0);let a=d(s,"ref",15);var n=xt();v(n,t=>a(t),()=>a()),e(p,n),L()}var _t=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> Select <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
...
</pre>`);function Ft(p,s){u(s,!0);let a=d(s,"ref",15);var n=_t();v(n,t=>a(t),()=>a()),e(p,n),L()}var Pt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
...
</pre>`);function jt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Pt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Ct=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;checkbox&quot; class=&quot;switch&quot; defaultChecked /&gt;
...
</pre>`);function Dt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Ct();v(n,t=>a(t),()=>a()),e(p,n),L()}var $t=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;input type=&quot;checkbox&quot; class=&quot;switch-line&quot; /&gt;
...
</pre>`);function Kt(p,s){u(s,!0);let a=d(s,"ref",15);var n=$t();v(n,t=>a(t),()=>a()),e(p,n),L()}var Tt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;div
<span class="LineNr">  </span><span class="LineNr">  2 </span>  class=&quot;[&amp;&gt;*:nth-child(even)]:ml3 gap-(x3 y7) grid-(~ cols-[auto_1fr]) items-center&quot;
<span class="LineNr">  </span><span class="LineNr">  3 </span>&gt;
...
</pre>`);function It(p,s){u(s,!0);let a=d(s,"ref",15);var n=Tt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Bt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> toast <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
...
</pre>`);function zt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Bt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Et=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script&gt;
...
</pre>`);function Ot(p,s){u(s,!0);let a=d(s,"ref",15);var n=Et();v(n,t=>a(t),()=>a()),e(p,n),L()}var At=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> toast <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
...
</pre>`);function Ut(p,s){u(s,!0);let a=d(s,"ref",15);var n=At();v(n,t=>a(t),()=>a()),e(p,n),L()}var Rt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script lang=&quot;ts&quot;&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; toast &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>
...
</pre>`);function Mt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Rt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Vt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> toast <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
...
</pre>`);function Wt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Vt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Ht=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script &gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; toast &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>
...
</pre>`);function Gt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Ht();v(n,t=>a(t),()=>a()),e(p,n),L()}var Jt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span><span class="Keyword">import</span> <span class="Function">&#123;</span> toast <span class="Function">&#125;</span> <span class="Keyword">from</span> <span class="String">&quot;@haze-ui/react&quot;</span>;
<span class="LineNr">  </span><span class="LineNr">  2 </span>
<span class="LineNr">  </span><span class="LineNr">  3 </span><span class="Keyword">const</span> newToast = <span class="javaScriptParens">(</span>css<span class="javaScriptParens">)</span> =&gt; <span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  toast<span class="javaScriptParens">(</span><span class="Function">&#123;</span>
<span class="LineNr">  </span><span class="LineNr">  5 </span>    title: <span class="String">&quot;Toast Activated&quot;</span>,
...
</pre>`);function Qt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Jt();v(n,t=>a(t),()=>a()),e(p,n),L()}var Xt=l(`<pre><span class="LineNr">  </span><span class="LineNr">  1 </span>&lt;script&gt;
<span class="LineNr">  </span><span class="LineNr">  2 </span>  import &#123; toast &#125; from &quot;@haze-ui/svelte&quot;;
<span class="LineNr">  </span><span class="LineNr">  3 </span>
<span class="LineNr">  </span><span class="LineNr">  4 </span>  const newToast = (css) =&gt; &#123;
<span class="LineNr">  </span><span class="LineNr">  5 </span>    toast(&#123;
...
</pre>`);function Yt(p,s){u(s,!0);let a=d(s,"ref",15);var n=Xt();v(n,t=>a(t),()=>a()),e(p,n),L()}const Os=Object.assign({"/codemos/badge/colors.svelte":Ra,"/codemos/badge/size.svelte":Va,"/codemos/badge/usage.svelte":Ha,"/codemos/btn/class.svelte":Ja,"/codemos/btn/html.svelte":Xa,"/codemos/btn/icons.svelte":Za,"/codemos/btn/size.svelte":an,"/codemos/btn/variant.svelte":pn,"/codemos/checkbox/colors.svelte":en,"/codemos/checkbox/default.svelte":cn,"/codemos/checkbox/form.svelte":on,"/codemos/dialog/usage.svelte":dn,"/codemos/dropdown/usage.svelte":wn,"/codemos/input/form.svelte":Fn,"/codemos/input/html.svelte":jn,"/codemos/input/size.svelte":Dn,"/codemos/input/usage.svelte":Kn,"/codemos/radio/colors.svelte":In,"/codemos/radio/default.svelte":zn,"/codemos/radio/form.svelte":On,"/codemos/select/usage.svelte":Un,"/codemos/switch/colors.svelte":Mn,"/codemos/switch/default.svelte":Wn,"/codemos/switch/form.svelte":Gn,"/codemos/toast/colors.svelte":lp,"/codemos/toast/pos.svelte":dp,"/codemos/toast/usage.svelte":bp,"/codemos/toast/variant.svelte":yp}),us=Object.assign({"/codemocomps/badge/colors.svelte":wp,"/codemocomps/badge/size.svelte":kp,"/codemocomps/badge/usage.svelte":Fp,"/codemocomps/btn/class-jsx.svelte":jp,"/codemocomps/btn/class.svelte":Dp,"/codemocomps/btn/html.svelte":Kp,"/codemocomps/btn/icons-jsx.svelte":Ip,"/codemocomps/btn/icons.svelte":zp,"/codemocomps/btn/size-jsx.svelte":Op,"/codemocomps/btn/size.svelte":Up,"/codemocomps/btn/variant-jsx.svelte":Mp,"/codemocomps/btn/variant.svelte":Wp,"/codemocomps/checkbox/colors.svelte":Gp,"/codemocomps/checkbox/default.svelte":Qp,"/codemocomps/checkbox/form.svelte":Yp,"/codemocomps/dialog/usage-jsx.svelte":st,"/codemocomps/dialog/usage.svelte":nt,"/codemocomps/dropdown/usage-jsx.svelte":tt,"/codemocomps/dropdown/usage.svelte":lt,"/codemocomps/input/form-jsx.svelte":rt,"/codemocomps/input/form.svelte":ot,"/codemocomps/input/html.svelte":Lt,"/codemocomps/input/size-jsx.svelte":dt,"/codemocomps/input/size.svelte":qt,"/codemocomps/input/usage-jsx.svelte":mt,"/codemocomps/input/usage.svelte":ft,"/codemocomps/radio/colors.svelte":yt,"/codemocomps/radio/default.svelte":wt,"/codemocomps/radio/form.svelte":kt,"/codemocomps/select/usage-jsx.svelte":Ft,"/codemocomps/select/usage.svelte":jt,"/codemocomps/switch/colors.svelte":Dt,"/codemocomps/switch/default.svelte":Kt,"/codemocomps/switch/form.svelte":It,"/codemocomps/toast/colors-jsx.svelte":zt,"/codemocomps/toast/colors.svelte":Ot,"/codemocomps/toast/pos-jsx.svelte":Ut,"/codemocomps/toast/pos.svelte":Mt,"/codemocomps/toast/usage-jsx.svelte":Wt,"/codemocomps/toast/usage.svelte":Gt,"/codemocomps/toast/variant-jsx.svelte":Qt,"/codemocomps/toast/variant.svelte":Yt}),oe=(p,s)=>{const a=`/codemos/${p}/${s}`,n=`/codemocomps/${p}/${s}`;return{preview:Os[`${a}.svelte`],code:{svelte:us[`${n}.svelte`],react:us[`${n}-jsx.svelte`],solid:us[`${n}-jsx.svelte`]}}},ue=(p,s)=>{const a=`/codemos/${p}/${s}`,n=`/codemocomps/${p}/${s}`;return{preview:Os[`${a}.svelte`],code:{html:us[`${n}.svelte`]}}};export{ie as T,oe as a,ue as g};
